...
namespace Mfa.Utilities
{
    ...
    /// file in %APPDATA%\BASeCamp\DebugLogs\AppName. Just make sure it get's initialized by calling it in some fashion- setting EnableDebugging to True is usually good enough.
    ...
    public class DebugLogger : TraceListener
    {
        ...
        public static void InitializeLogging(String sProgramName)
        {
            Log = new DebugLogger(sProgramName);
            EnableLogging = true;
        }
        ...
        private void WriteLogHeader()
        {
            ...
            LogStream.WriteLine(_LoggerName);
        ...
        {
            String BasePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "Mainframe Associates\\DebugLogs", _LoggerName);
