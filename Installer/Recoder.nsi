...
!define PROGPATH "..\recoder\bin\release"
!define PROGFILE "Recoder"
!include "x64IconHack.nsi"
!tempfile INC_FILE
...
!define FULLNAME "${COMPANY}\BASeCamp Recoder"

!define INSTNAME "BASeCamp Recoder (${PROGDATE}).exe"
